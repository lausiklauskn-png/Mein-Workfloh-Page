# Rechte und Urheberschaft — WorkFloh (Seite)

**Rechteinhaber:** Klaus Nitzsche. **Stand:** 2026-08-16.

**Lizenz:** die App-Lizenz in [`LICENSE`](LICENSE) — jede bisher
veröffentlichte Fassung darf jeder kostenlos nutzen, auch geschäftlich.
Weitergabe, Weiterverkauf und veränderte Fassungen brauchen die schriftliche
...
dem Sage-Protokol stehen unter der MIT-Lizenz und dürfen frei weiterverwendet
werden; diese Lizenz beschränkt nur die App selbst.

**Volle Fassung**, gepflegt an einer Stelle fürs ganze Netz — samt Faktencheck
zum Wasserzeichen-Gerücht vom August 2026:
<https://github.com/lausiklauskn-png/Sage-Protokol/blob/main/docs/URHEBERSCHAFT_UND_RECHTE.md>
